...
describe('validateOperation', () => {
    test.each<[any, string | null | undefined]>([
        ...
        [{ ...operation, documentId: Buffer.allocUnsafe(0) }, undefined],
        [{ ...operation, sessionId: '' }, undefined],
        [{ ...operation, sessionId: Buffer.allocUnsafe(0) }, undefined],
        [null, null],
        [() => undefined, null],
...
describe('validateSnapshot', () => {
    test.each<[any, string | null | undefined]>([
        ...
        [{ ...snapshot, documentId: Buffer.allocUnsafe(0) }, undefined],
        [{ ...snapshot, sessionId: '' }, undefined],
        [{ ...snapshot, sessionId: Buffer.allocUnsafe(0) }, undefined],
        [null, null],
        [() => undefined, null],
