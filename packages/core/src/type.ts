...
export type OperationMeta = JsonValue
export type DocumentId = string
export type SnapshotMeta = JsonValue
...
const validateNumber: (
    property: 'version' | 'schema',
    minVersion: number,
) => ValidatorFactory = (property, minValue) => code => self =>
    !Number.isSafeInteger(self[property]) || self[property] < minValue
        ? invalid(code, property)
        : undefined
...
export const validateOperation: Validator<Operation> = validate(
    [
        ...
        validateJson('meta'),
        validateNumber('schema', 0),
        validateSequence,
        validateType,
        validateNumber('version', 1),
